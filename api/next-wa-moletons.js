const WA_TEXT = encodeURIComponent('Quero COMPRAR MOLETOM POR R$59');
const WA_LINKS = [
  `https://wa.me/5547997609773?text=${WA_TEXT}`,
  `https://wa.me/5547999989815?text=${WA_TEXT}`,
];

const COUNTER_KEY = 'tiggas_wa_counter_moletons';
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error('[next-wa-moletons]', err);
